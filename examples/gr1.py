...
# X0 and not everything else OR X1 and not everything else OR ...
...
# strategy.run('Sinit')
# machines.MealyMachine.run(strategy, 'Sinit')

# strategy.interactive_run('Sinit')

# machines.interactive_run(strategy, from_state='Sinit')
