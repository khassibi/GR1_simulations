...
def experiment():
    ...
    # sys.states.add_from(['c1', 'c2', 'c3', 'c4']) # original
    sys.states.add_from(['c1', 'c2', 'c3', 'c4', 'c5', 'c6']) # changed
    sys.states.initial.add('c1')  # start in state c1

    # sys.transitions.add_comb({'c1'}, {'c2', 'c3'}) # original
    sys.transitions.add_comb({'c1'}, {'c2', 'c3', 'c5'}) # changed
    # sys.transitions.add_comb({'c1'}, {'c1', 'c2', 'c3'}) # makes the system realizable
    sys.transitions.add_comb({'c2'}, {'c4'})
    sys.transitions.add_comb({'c3'}, {'c4'})
    sys.transitions.add_comb({'c4'}, {'c4'})
    sys.transitions.add_comb({'c5'}, {'c6'}) # added
    sys.transitions.add_comb({'c6'}, {'c5'}) # added

    # sys.atomic_propositions.add_from({'a1', 'a2', 'a3', 'a4'}) # original
    sys.atomic_propositions.add_from({'a1', 'a2', 'a3', 'a4', 'a5', 'a6'}) # changed
    sys.states.add('c1', ap={'a1'})
    sys.states.add('c2', ap={'a2'})
    sys.states.add('c3', ap={'a3'})
    sys.states.add('c4', ap={'a4'})
    sys.states.add('c5', ap={'a5'}) # added
    sys.states.add('c6', ap={'a6'}) # added
